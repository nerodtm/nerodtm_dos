...
NERODTM_BANNER = 'DDOS v2.1 by NERODTM <ABC@ABC.org>'
    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print("{0} Nerodtm strikes hit. ({1} Failed)".format(self.counter[0], self.counter[1]))
...
def usage():
    ...
    print(NERODTM_BANNER)
    print()
    print(' USAGE: ./nerodtm.py <url> [OPTIONS]')
    print()
    print(' OPTIONS:')
...
def main():
    ...
    try:
        ...
        nerodtm = Nerodtm(url)
        nerodtm.useragents = useragents
        nerodtm.nr_workers = workers
        nerodtm.method = method
        nerodtm.nr_sockets = socks
